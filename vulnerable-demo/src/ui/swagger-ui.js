const swaggerUiOptions = {
  customSiteTitle: "Insecure Notes · API Lab",
  customCss: `
    html, body { background: #0d1117; }
    body { color: #e6edf3; font-family: Inter, ui-sans-serif, system-ui, sans-serif; }
    .swagger-ui {
      background: radial-gradient(circle at top left, #182437 0, #0d1117 38rem);
      color: #e6edf3;
      min-height: 100vh;
      padding-bottom: 4rem;
    }
    ...
    .swagger-ui .info .title small { background: #3d1f1c; border-radius: 99px; color: #ffb4ab; line-height: 1; padding: .18rem .52rem; vertical-align: middle; }
    ...
    .swagger-ui .info code { background: #010409; border-radius: 5px; color: #d2a8ff; padding: .14rem .32rem; }
    ...
    .swagger-ui .prop-type { color: #d2a8ff; }
    .swagger-ui .btn.authorize {
      border-color: #ff7b72;
      color: #ffb4ab;
    }
    .swagger-ui .btn.authorize svg { fill: #ff7b72; }
    .swagger-ui .btn.execute { background: #da3633; border-color: #ff7b72; color: #fff; }
    .swagger-ui .btn.cancel { border-color: #8b949e; color: #c9d1d9; }
    .swagger-ui .btn:focus-visible { outline: 3px solid rgba(255, 123, 114, .48); outline-offset: 2px; }
    ...
    .swagger-ui input:focus, .swagger-ui textarea:focus, .swagger-ui select:focus {
      outline: 3px solid rgba(255, 123, 114, .25);
      outline-offset: 1px;
    }
